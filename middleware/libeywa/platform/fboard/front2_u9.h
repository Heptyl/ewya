#ifndef __COMMON_XBH_F2_U9_BOARD_H__
#define __COMMON_XBH_F2_U9_BOARD_H__

#include <hardware/board.h>

#ifdef XBH_BOARD_GPIO_F_IIC_BUS
#define F2U9_IIC_BUS                 XBH_BOARD_GPIO_F_IIC_BUS
#else
#define F2U9_IIC_BUS                -1
#endif
 ...
 * 最大支持2x4的矩阵
 */
#undef XBH_F2U9_HDMI_SWITCH_TABLE
#define XBH_F2U9_HDMI_SWITCH_TABLE \
    GSV2712_1
 ...
 *  };
 */
#undef XBH_F2U9_HDMI_SWITCH_IIC_TABLE
#define XBH_F2U9_HDMI_SWITCH_IIC_TABLE \
    {F2U9_IIC_BUS, 0x58, -1, -1, -1, -1, XBH_BOARD_GPIO_F_USBC_RST, XBH_BOARD_GPIO_F_USBC_RST_LEVEL, 0}
 ...
 *  };
 */
#undef XBH_F2U9_HDMI_SWITCH_PORT_TABLE
#define XBH_F2U9_HDMI_SWITCH_PORT_TABLE \
    {XBH_SOURCE_F_HDMI1, XBH_SOURCE_F_USBC1, 0x00, 0x00}

/*******************************************************************************switch table*****************************************************************************/
static GPIO_OPT_TABLE source_android_table_ext_before_2_u9[] = {
...
static GPIO_OPT_TABLE source_android_table_ext_after_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,           XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
...
static GPIO_OPT_TABLE source_src_table_ext_before_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_src_table_ext_after_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_f_usbc1_table_ext_before_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,           !XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
...
static GPIO_OPT_TABLE source_f_usbc1_table_ext_after_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,      XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,               XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_f_usbc2_table_ext_before_2_u9[] = {
    
};

static GPIO_OPT_TABLE source_f_usbc2_table_ext_after_2_u9[] = {
    
};

static GPIO_OPT_TABLE source_f_hdmi1_table_ext_before_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,           !XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_DELAY,              {50 * 1000}},\
...
static GPIO_OPT_TABLE source_f_hdmi1_table_ext_after_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_f_hdmi2_table_ext_before_2_u9[] = {

};

static GPIO_OPT_TABLE source_f_hdmi2_table_ext_after_2_u9[] = {

};

//FCT
static GPIO_OPT_TABLE fct_source_android_table_ext_before_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \

};

static GPIO_OPT_TABLE fct_source_android_table_ext_after_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE fct_source_src_table_ext_before_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
};

static GPIO_OPT_TABLE fct_source_src_table_ext_after_2_u9[] = {
    {REQUEST_DELAY,              {300 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,               XBH_BOARD_GPIO_F_USB_PWR_LEVEL}}
};

static GPIO_OPT_TABLE fct_source_f_usbc1_table_ext_before_2_u9[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_usbc1_table_ext_after_2_u9[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_usbc2_table_ext_before_2_u9[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_usbc2_table_ext_after_2_u9[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_hdmi1_table_ext_before_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,               !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,      !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,            !XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_SEL,               XBH_BOARD_GPIO_F_USB_SEL_B}},\
...
static GPIO_OPT_TABLE fct_source_f_hdmi1_table_ext_after_2_u9[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,             XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_DELAY,              {300 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
...
static GPIO_OPT_TABLE fct_source_f_hdmi2_table_ext_before_2_u9[] = {

};

static GPIO_OPT_TABLE fct_source_f_hdmi2_table_ext_after_2_u9[] = {
