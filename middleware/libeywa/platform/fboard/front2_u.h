#ifndef __COMMON_XBH_F2_U_BOARD_H__
#define __COMMON_XBH_F2_U_BOARD_H__

#include <hardware/board.h>

#ifdef XBH_BOARD_GPIO_F_HDMI_SEL
#define F2U_HDMI_SEL                 XBH_BOARD_GPIO_F_HDMI_SEL
#else
#define F2U_HDMI_SEL                -1
#endif

#ifdef XBH_BOARD_GPIO_F_HDMI_SEL_POARA
#define F2U_HDMI_SEL_PORTA          XBH_BOARD_GPIO_F_HDMI_SEL_POARA
#else
#define F2U_HDMI_SEL_PORTA          -1
#endif

#ifdef XBH_BOARD_GPIO_F_IIC_BUS
#define F2U_IIC_BUS                 XBH_BOARD_GPIO_F_IIC_BUS
#else
#define F2U_IIC_BUS                -1
#endif
 ...
 * 最大支持2x4的矩阵
 */
#undef XBH_F2U_HDMI_SWITCH_TABLE
#define XBH_F2U_HDMI_SWITCH_TABLE \
    ASW3642
 ...
 *  };
 */
#undef XBH_F2U_HDMI_SWITCH_IIC_TABLE
#define XBH_F2U_HDMI_SWITCH_IIC_TABLE \
    {-1, -1, F2U_HDMI_SEL, F2U_HDMI_SEL_PORTA, -1, -1, -1, -1, 0}
 ...
 *  };
 */
#undef XBH_F2U_HDMI_SWITCH_PORT_TABLE
#define XBH_F2U_HDMI_SWITCH_PORT_TABLE \
 ...
 */
#undef XBH_F2U_USBC_2_HDMI_TABLE
#define XBH_F2U_USBC_2_HDMI_TABLE \
    LT8711UXE1
/*
 * USBC转HDMI 器件的操作元素
 ...
 */
#undef XBH_F2U_USBC_2_HDMI_IIC_TABLE
#define XBH_F2U_USBC_2_HDMI_IIC_TABLE \
    {F2U_IIC_BUS, -1, 0x3f, -1, XBH_BOARD_GPIO_F_USBC_PWR, XBH_BOARD_GPIO_F_USBC_PWR_LEVEL, XBH_BOARD_GPIO_F_USBC_RST, XBH_BOARD_GPIO_F_USBC_RST_LEVEL}
/*
 * USBC 对应的 转型芯片，顺序跟XBH_USBC_2_HDMI_TABLE 一一对应
*/
#undef XBH_F2U_USBC_PORT_TABLE
#define XBH_F2U_USBC_PORT_TABLE \
    XBH_SOURCE_F_USBC1

/*******************************************************************************switch table*****************************************************************************/
static GPIO_OPT_TABLE source_android_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_android_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_src_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
};

static GPIO_OPT_TABLE source_src_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE source_f_usbc1_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,     !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
...
static GPIO_OPT_TABLE source_f_usbc1_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,            XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
...
static GPIO_OPT_TABLE source_f_usbc2_table_ext_before_2_u[] = {
    
};

static GPIO_OPT_TABLE source_f_usbc2_table_ext_after_2_u[] = {
    
};

static GPIO_OPT_TABLE source_f_hdmi1_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,               !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,      !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,            !XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_SEL,               XBH_BOARD_GPIO_F_USB_SEL_B}},\
...
static GPIO_OPT_TABLE source_f_hdmi1_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,             XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_DELAY,              {300 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
...
static GPIO_OPT_TABLE source_f_hdmi2_table_ext_before_2_u[] = {
    
};

static GPIO_OPT_TABLE source_f_hdmi2_table_ext_after_2_u[] = {
    
};

//FCT
static GPIO_OPT_TABLE fct_source_android_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
};

static GPIO_OPT_TABLE fct_source_android_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
};

static GPIO_OPT_TABLE fct_source_src_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,                !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
};

static GPIO_OPT_TABLE fct_source_src_table_ext_after_2_u[] = {
    {REQUEST_DELAY,              {300 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,               XBH_BOARD_GPIO_F_USB_PWR_LEVEL}}
};

static GPIO_OPT_TABLE fct_source_f_usbc1_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,              !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST,              !XBH_BOARD_GPIO_F_HUB_RST_LEVEL}}, \
};

static GPIO_OPT_TABLE fct_source_f_usbc1_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST,              XBH_BOARD_GPIO_F_HUB_RST_LEVEL}}, \
};

static GPIO_OPT_TABLE fct_source_f_usbc2_table_ext_before_2_u[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_usbc2_table_ext_after_2_u[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_hdmi1_table_ext_before_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_PWR,               !XBH_BOARD_GPIO_F_USB_PWR_LEVEL}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,      !XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,            !XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_USB_SEL,               XBH_BOARD_GPIO_F_USB_SEL_B}},\
...
static GPIO_OPT_TABLE fct_source_f_hdmi1_table_ext_after_2_u[] = {
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_TX_RST,             XBH_BOARD_GPIO_F_HUB_TX_RST_LEVEL}}, \
    {REQUEST_DELAY,              {300 * 1000}},\
    {REQUEST_GPIO,               {XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY,       XBH_BOARD_GPIO_F_HUB_RST_ACTUALLY_LEVEL}}, \
    {REQUEST_DELAY,              {500 * 1000}},\
...
static GPIO_OPT_TABLE fct_source_f_hdmi2_table_ext_before_2_u[] = {
    
};

static GPIO_OPT_TABLE fct_source_f_hdmi2_table_ext_after_2_u[] = {
