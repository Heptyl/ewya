#ifndef XBH_XMA311D2B2_H
#define XBH_XMA311D2B2_H
...
class XbhXMA311D2_B2 : public XbhAmlogic_311d2
{
public:
    static XbhXMA311D2_B2* getInstance();
    //override
...
private:
    static XbhXMA311D2_B2 *mInstance;
