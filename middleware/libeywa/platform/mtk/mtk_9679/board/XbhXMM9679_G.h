#ifndef XBH_XMM9679_G_H
#define XBH_XMM9679_G_H
...
class XbhXMM9679_G : public XbhMtk_9679
{
public:
    static XbhXMM9679_G* getInstance();
    //-------------------------------------------------------------------------------override---------------------------------------------------------------
    //override
    ...
    //override
    XBH_S32 setMultiPanel(XBH_S32 type, XBH_PANEL_NUM_E enPanel) override;
    //override
