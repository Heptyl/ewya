#define LOG_NDEBUG 0
#define XBH_LOG_TAG "xbh_mw@XbhXMR3576_A"
...
#include <unistd.h>
#include <sys/stat.h>
XbhXMR3576_A            *XbhXMR3576_A::mInstance = XBH_NULL;
XbhMutex                 XbhXMR3576_A::mLock;
...
XBH_S32 XbhXMR3576_A::getHdmi1Det(XBH_BOOL *enable)
{
...
XBH_S32 XbhXMR3576_A::getHdmi2Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getFHdmi1Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getUsbc1Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getFUsbc1Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getDP1Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getOps1Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getOut1Det(XBH_BOOL *enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_U8 data[1] = {0};
...
XBH_S32 XbhXMR3576_A::setOpsPowerCtrl(XBH_SOURCE_E enSource)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getOpsPowerStatus(XBH_BOOL *bEnable, XBH_SOURCE_E enSource)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getOpsDetStatus(XBH_BOOL *bEnable, XBH_SOURCE_E enSource)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    #ifdef XBH_BOARD_GPIO_OPS_1_DET
    XBH_U32 u32GpioValue;
...
XBH_S32 XbhXMR3576_A::setOpsPowerEnable(XBH_BOOL bEnable, XBH_SOURCE_E enSource)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getOpsPowerEnable(XBH_BOOL *bEnable, XBH_SOURCE_E enSource)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    #ifdef XBH_BOARD_GPIO_OPS_PWREN
    XBH_U32 u32GpioValue;
...
XBH_S32 XbhXMR3576_A::getAirSensorExist(XBH_BOOL* bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getAirSensorValue(XBH_FLOAT* fHumidity, XBH_FLOAT* fTemperature, XBH_FLOAT* fTvoc, XBH_FLOAT* fPm2p5, XBH_FLOAT* fPm1p0, XBH_FLOAT* fPm10, XBH_FLOAT* fCo2)
{
...
XBH_S32 XbhXMR3576_A::setMute(XBH_AUDIO_CHANNEL_E enAudioChannel, XBH_BOOL bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getMute(XBH_AUDIO_CHANNEL_E enAudioChannel, XBH_BOOL* bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getHdmiTxInfo(XBH_HDMI_TX_INFO_E enInfo, XBH_CHAR* info)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    std::string value;
...
XBH_S32 XbhXMR3576_A::setHdmiTxInfo(XBH_HDMI_TX_INFO_E enInfo, XBH_U32 u32Data)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::setHdmirxEdidType(XBH_HDMIRX_EDID_TYPE_E enType, int bd_idx)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getHdmirxEdidType(int bd_idx, XBH_HDMIRX_EDID_TYPE_E *enType)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_S32 type  = 2;
...
XBH_S32 XbhXMR3576_A::getMicDetectStatus(XBH_BOOL* status)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getHpDetectStatus(XBH_BOOL* status)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getArcDetectStatus(XBH_BOOL* status)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}

XBH_S32 XbhXMR3576_A::getAmpInitStatus(XBH_BOOL* value)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    *value = XBH_TRUE;
    return s32Ret;
...
XBH_S32 XbhXMR3576_A::getPirSensorValue(XBH_S32 *s32Value)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}

XBH_S32 XbhXMR3576_A::getHallSensorValue(XBH_S32* s32Value)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return s32Ret;
}

XBH_S32 XbhXMR3576_A::getPirSensorExist(XBH_BOOL* bEnable)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    *bEnable = 0;
    return  s32Ret;
...
XBH_S32 XbhXMR3576_A::getHallSensorExist(XBH_BOOL* bEnable)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    *bEnable = 0;
    return  s32Ret;
...
XBH_S32 XbhXMR3576_A::getExtendIcVer(XBH_S32 devType, XBH_CHAR* ver)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    switch(devType)
    {
...
XBH_S32 XbhXMR3576_A::upgradeExtendIc(const XBH_CHAR* filename, XBH_BOOL force, XBH_U32 devType)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    switch(devType)
    {
...
XBH_S32 XbhXMR3576_A::getUpgradeExtIcState(XBH_S32 devType, XBH_S32* s32Value)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    switch(devType)
    {
...
XBH_S32 XbhXMR3576_A::openEthWol(XBH_BOOL bEnable)
{
...
XBH_S32 XbhXMR3576_A::getSrcDetByDetGpio(XBH_S32 gpio, XBH_U32 u32GpioValue, XBH_SOURCE_E *src, XBH_BOOL *bEnable)
{
...
XBH_S32 XbhXMR3576_A::setHdmiRx5vDet(XBH_BOOL enable)
{
...
XBH_S32 XbhXMR3576_A::setOnStop()
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::initSrcDetGpioIrq()
{
    XBH_S32 s32Ret = XBH_FAILURE;
    #if 0
...
XBH_S32 XbhXMR3576_A::setUsbLockMode(XBH_U32 u32UsbType)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::getUsbLockMode(XBH_U32 *u32UsbType)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    char type[PROPERTY_VALUE_MAX] = {0};
...
*/
XBH_S32 XbhXMR3576_A::setAvcEnable(XBH_BOOL bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
 ...
 * retval 0:success,-1:failure
*/
XBH_S32 XbhXMR3576_A::getAvcEnable(XBH_BOOL* bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::setLiftbracketOperate(XBH_S32 value)
{
    XBH_S32 ret = XbhLiftbracketManager::getInstance()->setLiftbracketOperate(value);
    return ret;
}

XBH_S32 XbhXMR3576_A::getLiftbracketExist(XBH_S32* value)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 XbhXMR3576_A::setHdmiLowLatency(XBH_BOOL bEnable)
{
    XBH_S32 ret = XbhRk_3576::setHdmiLowLatency(bEnable);
    return ret;
}

XBH_S32 XbhXMR3576_A::setSourcePdAbility(XBH_PDCAPACITY_POWER pdability, XBH_SOURCE_E enSource)
{
...
XBH_S32 XbhXMR3576_A::setOpsResetEnable(XBH_BOOL bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    if (bEnable)
    {
 ...
 * @param projecitd
 */
XBH_S32 XbhXMR3576_A::readAndUpdateEdidBinFile(int projectid)
{
 ...
 * 初始化project_id配置
 */
XBH_S32 XbhXMR3576_A::initProjectIdConfig()
{
    //每次开机都需要更新edid的数据
    XBH_S32 projectid = property_get_int32("persist.vendor.xbh.project_id", 0);
    XBH_S32 type = 1;
 ...
 * status 1:无信号，0：有信号
 */
XBH_S32 XbhXMR3576_A::getHdmi1SignalStatus(XBH_S32 *status)
{
 ...
 * status 1:无信号，0：有信号
 */
XBH_S32 XbhXMR3576_A::getHdmi2SignalStatus(XBH_S32 *status)
{
    return this->XbhRk_3576::getSignalStatus(status);
}
 ...
 * status 1:无信号，0：有信号
 */
XBH_S32 XbhXMR3576_A::getUsbc1SignalStatus(XBH_S32 *status)
{
    return this->XbhRk_3576::getSignalStatus(status);
}
 ...
 * status 1:无信号，0：有信号
 */
XBH_S32 XbhXMR3576_A::getDP1SignalStatus(XBH_S32 *status)
{
    return this->XbhRk_3576::getSignalStatus(status);
}
 ...
 * status 1:无信号，0：有信号
 */
XBH_S32 XbhXMR3576_A::getOps1SignalStatus(XBH_S32 *status)
{
    return this->XbhRk_3576::getSignalStatus(status);
}

XbhXMR3576_A *XbhXMR3576_A::getInstance()
{
    if (!mInstance)
    {
