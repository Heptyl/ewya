#ifndef XBH_AT32F407RC_H
#define XBH_AT32F407RC_H
...
class At32f407rc : public XbhMWThread, public XbhMcuInterface
{
public:
    At32f407rc(XBH_S32 iicBus, XBH_S32 iicAddr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel);
    ~At32f407rc();
...
private:
    ...
    XBH_S32 WriteMcuByte(XBH_U8 s32RegAddr, XBH_U8* pu8Data);
