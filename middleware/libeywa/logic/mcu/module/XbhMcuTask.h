#ifndef __XBH_MCU_TASK_H__
#define __XBH_MCU_TASK_H__
...
class XbhMcuTask : public XbhMWThread
{
public:
    static XbhMcuTask* getInstance();
    /**
     * 复位MCU芯片
    */
    XBH_S32 resetChip();
...
private:
    ...
    XbhMcuTask();
    static XbhMcuTask *mInstance;
    static XbhMutex mLock;

    XbhMcuInterface *m_pXbhMcuInterface[2];
