/*
    这套MCU升级实现支持如下版型：
    3576.B      MCU:GD32f310G8
    A311D2.X    MCU:GD32F305RB
    A311D2.B    MCU:GD32F350C8
*/

#define LOG_NDEBUG 0
#define XBH_LOG_TAG "xbh_mw@RkGd32f310g8"
#include "XbhLog.h"
 ...
 * 复位mcu芯片
*/
XBH_S32 RkGd32f310g8::resetChip()
{
 ...
 * 获取chip是否初始化完成
*/
XBH_S32 RkGd32f310g8::getChipInitDone(XBH_BOOL* enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}
 ...
 * 获取chip是否存在
*/
XBH_S32 RkGd32f310g8::getChipExist(XBH_BOOL* enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}

XBH_S32 RkGd32f310g8::calculate_CRC32_Mpeg2(void *pStart, unsigned int uiSize)
{
...
XBH_S32 RkGd32f310g8::WriteMcuMultiBytes(XBH_U8 s32RegAddr, XBH_U32 u32Length,  XBH_U8 *pu8Data)
{
...
XBH_S32 RkGd32f310g8::ReadMcuMultiBytes(XBH_U8 s32RegAddr, XBH_U32 u32Length, XBH_U8* pu8Data)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
...
XBH_S32 RkGd32f310g8::set_enter_iap_mode(void)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
...
XBH_S32 RkGd32f310g8::check_iap_CRC32(XBH_U32 pc_crc)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 RkGd32f310g8::set_iap_status(XBH_U8 status)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
...
XBH_S32 RkGd32f310g8::upgrade_download_data(XBH_U8 *buff, XBH_U32 length)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
...
XBH_S32 RkGd32f310g8::upgradetask(void)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
 ...
 * 获取固件版本
 */
XBH_S32 RkGd32f310g8::getFirmwareVersion(XBH_CHAR* strVersion)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
 ...
 * 进行固件升级
 */
XBH_S32 RkGd32f310g8::upgradeFirmware(const XBH_CHAR* strFilePath, XBH_BOOL bForceUpgrade)
{
    XbhMutex::Autolock _l(mLock);
 ...
 * 获取固件升级时的状态
 */
XBH_S32 RkGd32f310g8::getUpgradeState(XBH_S32 * s32State)
{
    *s32State = mState;
    return XBH_SUCCESS;
}

XBH_S32 RkGd32f310g8::setMcuFattMode(XBH_S32 mode)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    XBH_U8 pu8Data[1];
...
XBH_S32 RkGd32f310g8::getMcuFattMode(XBH_S32 *mode)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    XBH_U8 buf[64] = {0x00};
...
XBH_S32 RkGd32f310g8::setMcuIIcBypass(XBH_U8 u8IIcNum, XBH_U8 u8DeviceAddr, XBH_U8 u8RegAddr, XBH_U8 u8Len, XBH_U8* u8Data)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    XBH_U8 param[4] = {0x00};
    param[0] = u8IIcNum;
...
XBH_S32 RkGd32f310g8::getMcuIIcBypass(XBH_U8 u8IIcNum, XBH_U8 u8DeviceAddr, XBH_U8 u8RegAddr, XBH_U8 u8Len, XBH_U8* u8Data)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    XBH_U8 param[4] = {0x00};
    param[0] = u8IIcNum;
...
XBH_S32 RkGd32f310g8::setMcuUartBypassPara(XBH_U8 u8UartNum, XBH_U8 baud)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    XBH_U8 param[2] = {0x00};
    param[0] = u8UartNum;
...
XBH_S32 RkGd32f310g8::setMcuUartBypass(XBH_U8 u8Len, XBH_U8* u8Data)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
...
XBH_S32 RkGd32f310g8::getMcuUartBypass(XBH_U8 u8Len, XBH_U8* u8Data)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
...
void RkGd32f310g8::run(const void* arg)
{
    XbhMutex::Autolock _l(mLock);
    XBH_S32 s32Ret = XBH_SUCCESS;
    if (mUpgradeStatus == 1)
...
RkGd32f310g8::RkGd32f310g8(XBH_S32 iicBus, XBH_S32 iicAddr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel)
{
    XLOGD(" begin ");
    mI2cBus = iicBus;
    mI2cAddr = iicAddr;
