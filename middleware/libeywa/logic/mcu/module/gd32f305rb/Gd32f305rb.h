#ifndef XBH_GD32f305RB_H
#define XBH_GD32f305RB_H
...
class Gd32f305rb : public XbhMWThread, public XbhMcuInterface
{
public:
    Gd32f305rb(XBH_S32 iicBus, XBH_S32 iicAddr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel);
    ~Gd32f305rb();
