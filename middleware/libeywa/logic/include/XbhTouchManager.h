#ifndef __XBH_TOUCH_MANAGER_H__
#define __XBH_TOUCH_MANAGER_H__
...
class XbhTouchManager : public XbhMWThread 
{
public:
    static XbhTouchManager *getInstance();
    /**
     * 设置信号源的触摸开关。
     * enable 开关状态
     */
...
private:
    ...
    XbhTouchManager();
    static XbhTouchManager *mInstance;
    static XbhMutex mLockObject;

    XbhTouchControlInterface *m_pXbhTouchControlInterface;
};
