#ifndef __XBH_AUDIO_AMPLIFIER_MANAGER_H__
#define __XBH_AUDIO_AMPLIFIER_MANAGER_H__
...
class XbhAudioAmplifierManager
{
public:
    static XbhAudioAmplifierManager* getInstance();
    /**
     * 复位功放芯片
    */
    ...
    */
    ...
    ~XbhAudioAmplifierManager();

private:
    XbhAudioAmplifierManager();
    static XbhAudioAmplifierManager *mInstance;
    static XbhMutex mLock;

    XbhAudioAmplifierTask *m_pXbhAudioAmplifierTask;
};
