#ifndef XBH_NET_SWITCH_MANAGER_H
#define XBH_NET_SWITCH_MANAGER_H
...
class XbhNetSwitchManager : public XbhMWThread
{
public:
    static XbhNetSwitchManager* getInstance();
    /**
...
private:
    XbhNetSwitchManager();
    static XbhNetSwitchManager *mInstance;
    static XbhMutex mLock;
    XbhNetSwitchTask *m_pXbhNetSwitchTask;
};

#endif //XBH_NET_SWITCH_MANAGER_H
