#ifndef __XBH_AUDIO_CODEC_MANAGER_H__
#define __XBH_AUDIO_CODEC_MANAGER_H__
...
class XbhAudioCodecManager
{
public:
    static XbhAudioCodecManager* getInstance();
    /**
     * 复位codec芯片
    */
    XBH_S32 resetChip();
    ...
    */
    ...
    ~XbhAudioCodecManager();

private:
    XbhAudioCodecManager();
    static XbhAudioCodecManager *mInstance;
    static XbhMutex mLock;

    XbhAudioCodecTask *m_pXbhAudioCodecTask;
};
