#ifndef XBH_CHIP_AP8232_H
#define XBH_CHIP_AP8232_H
...
class ChipAp8232 : public XbhMWThread, public XbhAudioCodecInterface
{
public:
    /**
     *     
    ...
    */
    ChipAp8232(XBH_S32 iicBus, XBH_S32 iicAddr, XBH_S32 uart, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel, XBH_S32 mic_plug_gpio, XBH_S32 mic_plug_level, XBH_S32 hp_plug_gpio, XBH_S32 hp_plug_level, XBH_S32 hp_mute_gpio, XBH_S32 hp_mute_level);
    ~ChipAp8232();
...
private:
    ...
    XBH_S32 init();
    XBH_S32 Ap8232_Write(XBH_U8 *buf, XBH_U8 len);
    XBH_S32 Ap8232_Read(XBH_U8 *buf, XBH_U8 ctrl, XBH_U8 len);
    XBH_S32 Ap8232_LoadEffect();
    XBH_S32 Ap8232_Mic3Mute(XBH_BOOL mute);
    //for upgradeFirmware
    XBH_BOOL Ap8232_SendFileByIIC(XBH_U32 offset, XBH_U8 *buff, XBH_U32 lenght, XBH_U8 *pRepyFlag);
    XBH_S32 Ap8232_SendFileSizeByIIC(XBH_U32 filesize);
