#ifndef __XBH_TOUCH_CONTROL_INTERFACE_H__
#define __XBH_TOUCH_CONTROL_INTERFACE_H__

#include "XbhType.h"

class XbhTouchControlInterface 
{
public:
    /**
     * 设置信号源的触摸开关。
...
public:
    XbhTouchControlInterface(){};
    virtual ~XbhTouchControlInterface(){};
};
