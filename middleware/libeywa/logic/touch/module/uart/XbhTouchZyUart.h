#ifndef __HI_MW_XBHZYTOUCH_UART_H__
#define __HI_MW_XBHZYTOUCH_UART_H__
...
class XbhTouchZyUart : public  XbhTouchInterface
{
public:
...
private:
    ...
    XbhTouchZyUart(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchZyUart();
    static XbhTouchZyUart *mInstance;
