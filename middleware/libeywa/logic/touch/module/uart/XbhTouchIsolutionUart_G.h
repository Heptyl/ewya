#ifndef __HI_MW_XBHISOLUTIONUART_G_H__
#define __HI_MW_XBHISOLUTIONUART_G_H__
...
class XbhTouchIsolutionUart_G : public XbhTouchInterface
{
  public:
  ...
  private:
    ...
    XbhTouchIsolutionUart_G(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchIsolutionUart_G();
    static XbhTouchIsolutionUart_G *mInstance;
