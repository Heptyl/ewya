#ifndef __HI_MW_XBHCOMMON_UART_H__
#define __HI_MW_XBHCOMMON_UART_H__
...
class XbhTouchCommonUart : public  XbhTouchInterface
{
public:
...
private:
    ...
    XbhTouchCommonUart(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchCommonUart();
    static XbhTouchCommonUart *mInstance;
