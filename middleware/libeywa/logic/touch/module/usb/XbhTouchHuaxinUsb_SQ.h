#ifndef __HI_MW_XBHHUAXINUSB_SQ_H__
#define __HI_MW_XBHHUAXINUSB_SQ_H__
...
class XbhTouchHuaxinUsb_SQ: public XbhTouchInterface
{
public:
...
private:
    ...
    XbhTouchHuaxinUsb_SQ(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchHuaxinUsb_SQ();
    static XbhTouchHuaxinUsb_SQ *mInstance;
    static XbhMutex mLockObject;

    XBH_CHAR mKoName[32];
    XBH_CHAR mTpName[32];
    XBH_CHAR touchtype[32];
    XBH_S32 mFd;
};
#endif
