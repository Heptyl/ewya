#ifndef __HI_MW_XBHHUAXINUSB_COMMON_H__
#define __HI_MW_XBHHUAXINUSB_COMMON_H__
...
class XbhTouchHuaxinUsb_Common: public XbhTouchInterface
{
public:
...
private:
    ...
    XbhTouchHuaxinUsb_Common(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchHuaxinUsb_Common();
    static XbhTouchHuaxinUsb_Common *mInstance;
