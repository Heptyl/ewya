#ifndef __HI_MW_ISOLUTION_USB_E_H__
#define __HI_MW_ISOLUTION_USB_E_H__
...
class XbhTouchIsolutionUsb_E: public XbhTouchInterface, public XbhMWThread
{
public:
...
private:
    ...
    XBH_BOOL IsNonThroughData(XBH_S32 id, XBH_U32 status, XBH_S32 x, XBH_S32 y);
    XbhTouchIsolutionUsb_E(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchIsolutionUsb_E();
    static XbhTouchIsolutionUsb_E *mInstance;
