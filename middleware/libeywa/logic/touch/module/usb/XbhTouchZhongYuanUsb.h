#ifndef __HI_MW_XBHZONGYUANUSB_H__
#define __HI_MW_XBHZONGYUANUSB_H__
...
class XbhTouchZhongYuanUsb: public XbhTouchInterface
{
public:
...
private:
    ...
    XbhTouchZhongYuanUsb(XBH_CHAR *ko = XBH_NULL, XBH_CHAR *tpName = XBH_NULL);
    ~XbhTouchZhongYuanUsb();
    static XbhTouchZhongYuanUsb *mInstance;
