#ifndef __HI_MW_XBHTOUCHINTERFACE_USB_H__
#define __HI_MW_XBHTOUCHINTERFACE_USB_H__
...
class XbhTouchInterfaceUsb: public XbhTouchControlInterface
{
public:
...
private:
    ...
    XbhTouchInterfaceUsb();
    ~XbhTouchInterfaceUsb();
    static XbhTouchInterfaceUsb *mInstance;
    static XbhMutex mLockObject;

    XbhTouchInterface *m_pXbhTouchInterfaceUsb;
};
