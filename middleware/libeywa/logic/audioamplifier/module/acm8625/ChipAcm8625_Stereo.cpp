#define LOG_NDEBUG 0
#define XBH_LOG_TAG "xbh_mw@ChipAcm8625_Stereo"
#include "XbhLog.h"
...
XbhMutex                 ChipAcm8625_Stereo::mLock;
 ...
 * 复位功放芯片
*/
XBH_S32 ChipAcm8625_Stereo::resetChip()
{
 ...
 * 设置speaker 软mute的状态
*/
XBH_S32 ChipAcm8625_Stereo::setMute(XBH_BOOL mute)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_U8 data[1] = {0};
 ...
 * 获取speaker mute的状态
*/
XBH_S32 ChipAcm8625_Stereo::getMute(XBH_BOOL* mute)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_U8 data[1] = {0};
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, REG_PAGE, 0x01, 0x01, data);
 ...
 * 设置功放输出的增益值
*/
XBH_S32 ChipAcm8625_Stereo::setGain(XBH_S32 gain)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}
 ...
 * 获取功放输出的增益值
*/
XBH_S32 ChipAcm8625_Stereo::getGain(XBH_S32* gain)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}
 ...
 * 获取amp是否初始化完成
*/
XBH_S32 ChipAcm8625_Stereo::getChipInitDone(XBH_BOOL* enable)
{
    if(m_bInitDone)
    {
        *enable = XBH_TRUE;
 ...
 * 获取chip是否存在
*/
XBH_S32 ChipAcm8625_Stereo::getChipExist(XBH_BOOL* bEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return s32Ret;
}
 ...
 * 获取固件版本
 */
XBH_S32 ChipAcm8625_Stereo::getFirmwareVersion(XBH_CHAR* strVersion)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}
 ...
 * 进行固件升级
 */
XBH_S32 ChipAcm8625_Stereo::upgradeFirmware(const XBH_CHAR* strFilePath, XBH_BOOL bForceUpgrade)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}
 ...
 * 获取固件升级时的状态
 */
XBH_S32 ChipAcm8625_Stereo::getUpgradeState(XBH_S32 * s32State)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return  s32Ret;
}

XBH_S32 ChipAcm8625_Stereo::Acm8625_Write(XBH_U8 *buf, XBH_U8 len)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return s32Ret;
}

XBH_S32 ChipAcm8625_Stereo::Acm8625_Read(XBH_U8 *buf, XBH_U8 ctrl)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    return s32Ret;
}

XBH_S32 ChipAcm8625_Stereo::setAvcEnable(XBH_BOOL isAvcEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_U8 data[1] = {0};
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, REG_PAGE, 0x01, 0x01, data);
...
XBH_S32 ChipAcm8625_Stereo::getAvcEnable(XBH_BOOL *isAvcEnable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_U8 data[1] = {0};
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, REG_PAGE, 0x01, 0x01, data);
...
XBH_S32 ChipAcm8625_Stereo::setEqEnable(XBH_BOOL enable)
{
    XBH_S32 s32Ret = XBH_FAILURE;
    XBH_S32 i = 0;
    XBH_U8 data[1] = {0};
    ...
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, REG_PAGE, 0x01, 0x01, data);
    data[0] = 0x08;
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, 0xB0, 0x01, 0x01, data);
    ...
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, REG_PAGE, 0x01, 0x01, data);
    data[0] = 0x08;
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, 0xE0, 0x01, 0x01, data);
    ...
    data[0] =(enable ? DEVICE_STATE_AVC : DEVICE_STATE_UNEQ);
    s32Ret = XbhService::getModuleInterface()->setI2cData(mI2cBus, mI2cAddr, REG_DEVICE_AVC, 0x01, 0x01, data);
    if(s32Ret == XBH_FAILURE)
    {
        XLOGD(" setEqEnable setI2cData error!!");
...
XBH_S32 ChipAcm8625_Stereo::writeRegMap(amp8625RegMap *reg_map, XBH_S32 iicBus, XBH_S32 iicAddr)
{
...
XBH_S32 ChipAcm8625_Stereo::ParseIniConfig(const char *section, char *fileBuf, amp8625RegMap *pRegMap, XBH_U32 maxRegSize)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 ChipAcm8625_Stereo::LoadIniFileBuf(const XBH_CHAR *fileName, XBH_CHAR *buf, XBH_S32 *fileSize, XBH_S32 bufSize)
{
...
XBH_S32 ChipAcm8625_Stereo::WriteIniConfig(const XBH_CHAR *fileName)
{
    XBH_S32 s32Ret = XBH_FAILURE;
...
XBH_S32 ChipAcm8625_Stereo::init()
{
    XBH_S32 s32Ret = XBH_FAILURE;
    m_bInitDone = XBH_FALSE;
    WriteIniConfig(XBH_AUDIO_ACM8625S_AQ_STR_INI_FILE);
    m_bInitDone = XBH_TRUE;
    return s32Ret;
}

ChipAcm8625_Stereo::ChipAcm8625_Stereo(XBH_S32 iicBus, XBH_S32 iicAddr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel, XBH_S32 mute_gpio, XBH_S32 mute_level)
{
    XLOGD(" begin ");
    mI2cBus = iicBus;
    mI2cAddr = iicAddr;
...
ChipAcm8625_Stereo::~ChipAcm8625_Stereo()
{
