#ifndef _CHIP_IT66353_H_
#define _CHIP_IT66353_H_
...
class ChipIt66353 : public XbhMWThread, public XbhHdmiSwitchInterface
{
public:
    /**
     * DevNo        使用的IIC序号
     ...
     * SubDev       是否作为二级设备
    */
    ChipIt66353(XBH_U32 DevNo, XBH_U32 SwAddr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel, XBH_U8 defaultPort, HDMI_SWITCH_PORT u8SwitchPort, XBH_U8 level);
    ~ChipIt66353();
