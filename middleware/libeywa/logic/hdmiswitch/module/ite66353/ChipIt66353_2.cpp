#define LOG_NDEBUG 0
#define XBH_LOG_TAG "xbh_mw@ChipIt66353_2_InputSource"
...
void ChipIt66353_2::it6635_options_init()
{
...
#ifdef XBH_ITE66353_2_HDMI_PORT_0_EDID_ADDR
#define HDMI_PORT_0_EDID_ADDR       XBH_ITE66353_2_HDMI_PORT_0_EDID_ADDR
#else
#define HDMI_PORT_0_EDID_ADDR       1
#endif
#ifdef XBH_ITE66353_2_HDMI_PORT_1_EDID_ADDR
#define HDMI_PORT_1_EDID_ADDR       XBH_ITE66353_2_HDMI_PORT_1_EDID_ADDR
#else
#define HDMI_PORT_1_EDID_ADDR       4
#endif
#ifdef XBH_ITE66353_2_HDMI_PORT_2_EDID_ADDR
#define HDMI_PORT_2_EDID_ADDR       XBH_ITE66353_2_HDMI_PORT_2_EDID_ADDR
#else
#define HDMI_PORT_2_EDID_ADDR       5
#endif
#ifdef XBH_ITE66353_2_HDMI_PORT_3_EDID_ADDR
#define HDMI_PORT_3_EDID_ADDR       XBH_ITE66353_2_HDMI_PORT_3_EDID_ADDR
#else
...
XBH_U8 ChipIt66353_2::_rx_is_h14_tmds_over_1G(void)
{
    return it6635_get_port_info1( gdev.vars.Rx_active_port, PI_PLL_HS1G );
}

void ChipIt66353_2::_rx_DFE_enable( XBH_U8 enable )
{
    chgrxbank(3);
    if ( enable )
    {
...
void ChipIt66353_2::_rx_set_rs_3ch( XBH_U8 *rs_value )
{
    XBH_U8 rs[3];
...
void ChipIt66353_2::_rx_set_rs( XBH_U8 ch, XBH_U8 rs_value )
{
    rs_value|=0x80;
    chgrxbank(3);
...
XBH_U8 ChipIt66353_2::_rx_get_rs( XBH_U8 ch )
{
    XBH_U8 rs_value;
    chgrxbank(3);
...
void ChipIt66353_2::_rx_clear_ced_err(void)
{
...
void ChipIt66353_2::_rx_ced_err_recheck( void )
{
    XBH_U8 i;
    XBH_U8 tmp;
...
void ChipIt66353_2::_rx_update_ced_err_from_hw(void)
{
    XBH_U8 symlock;
...
void ChipIt66353_2::_rx_record_ced_err(void)
{
    XBH_U8 i;
...
XBH_U8 ChipIt66353_2::_rx_monitor_ced_err(void)
{
...
XBH_U8 ChipIt66353_2::_rx_is_hdmi20(void)
{
    #if 1
...
void ChipIt66353_2::_eq_save_h20(void)
{
    chgrxbank(3);
...
void ChipIt66353_2::_eq_load_h20(void)
{
...
void ChipIt66353_2::_eq_save_h14(void)
{
    chgrxbank(3);
...
void ChipIt66353_2::_eq_load_h14(void)
{
    PR_INFO(("_eq_load_h14\r\n"));
    _rx_set_rs_3ch( gdev.EQ.stored_RS_14 );
}

void ChipIt66353_2::_eq_load_previous(void)
{
    if ( _rx_is_hdmi20() )
    {
...
void ChipIt66353_2::_eq_load_default(void)
{
...
XBH_U8 ChipIt66353_2::_eq_find_rs_index(XBH_U8 EQ_Value)
{
    XBH_U8 i = 0;
    EQ_Value &= ~0x80;
...
void ChipIt66353_2::_eq_reset_txoe_ready(void)
{
    gdev.EQ.txoe_ready20 = 0;
    gdev.EQ.txoe_ready14 = 0;
}

void ChipIt66353_2::_eq_set_txoe_ready(XBH_U8 ready)
{
    if ( _rx_is_hdmi20() )
    {
...
XBH_U8 ChipIt66353_2::_eq_get_txoe_ready(void)
{
...
void ChipIt66353_2::_eq_reset_state(void)
{
    gdev.EQ.EQ_flag_20 = SysAEQ_RUN;
    gdev.EQ.EQ_flag_14 = SysAEQ_RUN;
}

void ChipIt66353_2::_eq_set_state(XBH_U8 state)
{
    if ( _rx_is_hdmi20() )
    {
...
XBH_U8 ChipIt66353_2::_eq_get_state(void)
{
...
XBH_U8 ChipIt66353_2::_aeq_ready_to_start(void)
{
    return _rx_is_clock_stable();
}

void ChipIt66353_2::_aeq_diable_eq_trigger(void)
{
    chgrxbank(3);
...
void ChipIt66353_2::_aeq_reset(void)
{
...
void ChipIt66353_2::_aeq_get_DFE2(XBH_U8 ch, XBH_U8 rs_idx)
{
    XBH_U8 i;
...
void ChipIt66353_2::_aeq_set_DFE2(XBH_U8 EQ0, XBH_U8 EQ1, XBH_U8 EQ2)
{
    XBH_U8 dfe[9];
    XBH_U8 i;
...
void ChipIt66353_2::_aeq_get_calc_rs(void)
{
    chgrxbank(3);
...
void ChipIt66353_2::_aeq_trigger_EQ(void)
{
    _aeq_reset();
...
void ChipIt66353_2::_aeq_trigger_SAREQ(void)
{
...
void ChipIt66353_2::_aeq_check_amp_and_rs_status(void)
{
    XBH_U8 i;
    XBH_U8 reg63, reg6D;
    XBH_U16 reg64, reg6E;
...
XBH_U8 ChipIt66353_2::_aeq_check_sareq_result(void)
{
    XBH_U8 tmp;
    tmp = h2rxrd(0x07);
...
XBH_U8 ChipIt66353_2::_aeq_check_h14eq_result(void)
{
    XBH_U8 tmp;
    tmp = h2rxrd(0x07);
...
XBH_U8 ChipIt66353_2::_meq_14(void)
{
    XBH_U8 rs_idx;
    XBH_U8 ch;
    XBH_U8 ch_all_done;
...
bool ChipIt66353_2::it6635_auto_eq_adjust(void)
{
    XBH_U8 result;
...
void ChipIt66353_2::_pr_buf(void *buffer, int length)
{
    int i;
...
XBH_U8 ChipIt66353_2::h2swwr(XBH_U8 offset, XBH_U8 wdata)
{
    if ( g_is_set_io == 0 ) {
...
XBH_U8 ChipIt66353_2::h2swrd(XBH_U8 offset)
{
    XBH_U8 rddata;
...
XBH_U8 ChipIt66353_2::h2swset(XBH_U8 offset, XBH_U8 mask, XBH_U8 wdata)
{
    XBH_U8 temp;
...
void ChipIt66353_2::h2swbrd(XBH_U8 offset, XBH_U8 length, XBH_U8 *rddata)
{
    if ( length > 0 )
    {
...
void ChipIt66353_2::h2swbwr(XBH_U8 offset, XBH_U8 length, XBH_U8 *rddata)
{
...
////////////////////////////////////////////////////////////////////////////////
XBH_U8 ChipIt66353_2::h2rxedidwr(XBH_U8 offset, XBH_U8 *wrdata, XBH_U8 length)
{
...
XBH_U8 ChipIt66353_2::h2rxedidrd(XBH_U8 offset, XBH_U8 *wrdata, XBH_U8 length)
{
    return it6635_i2c_read(gdev.opts.dev_opt->DevNo, gdev.opts.dev_opt->EdidAddr, offset, length, wrdata);
}

XBH_U8 ChipIt66353_2::h2rxwr(XBH_U8 offset, XBH_U8 rdata)
{
    if ( g_is_set_io == 0 ) {
        //PR_IO(("    ---> h2swwr(0x%02x, 0x%02x);\r\n", offset, rdata));
        //PR51_IO(("    ---> h2swwr(0x%02Bx, 0x%02Bx);\n", offset, rdata));
...
XBH_U8 ChipIt66353_2::h2rxrd(XBH_U8 offset)
{
    XBH_U8 rddata;
...
XBH_U8 ChipIt66353_2::h2rxset(XBH_U8 offset, XBH_U8 mask, XBH_U8 wdata)
{
    XBH_U8 temp;
...
void ChipIt66353_2::h2rxbrd(XBH_U8 offset, XBH_U8 length, XBH_U8 *rddata)
{
    if ( length > 0 )
    {
...
void ChipIt66353_2::h2rxbwr(XBH_U8 offset, XBH_U8 length, XBH_U8 *rddata)
{
...
void ChipIt66353_2::chgrxbank(XBH_U8 bankno)
{
...
bool ChipIt66353_2::_tx_is_sink_hpd_high(void)
{
    if ( h2swrd(0x11) & 0x20 )
    {
        return TRUE;
...
bool ChipIt66353_2::_tx_ddcwait(void)
{
...
XBH_U8 ChipIt66353_2::_tx_scdc_write(XBH_U8 offset, XBH_U8 wdata)
{
    int ddcwaitsts;
    XBH_U8 reg3C;
...
XBH_U8 ChipIt66353_2::_tx_scdc_read(XBH_U8 offset, XBH_U8 *data_buf)
{
    int ddcwaitsts;
    XBH_U8 reg3C;
...
XBH_U8 ChipIt66353_2::_tx_hdcp_write(XBH_U8 offset, XBH_U8 data)
{
    int ddcwaitsts;
...
XBH_U8 ChipIt66353_2::_tx_hdcp_read(XBH_U8 offset, XBH_U8 *data_buf, XBH_U8 len)
{
    int ddcwaitsts;
...
XBH_U8 ChipIt66353_2::_tx_scdc_read_ced(XBH_U8 *data_buf)
{
    int ddcwaitsts;
    XBH_U8 i;
...
void ChipIt66353_2::_tx_power_down(void)
{
...
void ChipIt66353_2::_tx_ovwr_hdmi_clk(XBH_U8 ratio)
{
    switch ( ratio )
    {
        case HDMI_MODE_AUTO:
...
void ChipIt66353_2::_tx_ovwr_h20_scrb(XBH_U8 scrb)
{
    switch ( scrb )
    {
        case HDMI_MODE_AUTO:
...
XBH_U8 ChipIt66353_2::_rx_is_ch_symlock(XBH_U8 ch)
{
...
void ChipIt66353_2::_rx_ovwr_hdmi_clk(XBH_U8 port, XBH_U8 ratio)
{
    switch ( ratio )
    {
        case HDMI_MODE_AUTO:
...
void ChipIt66353_2::_rx_ovwr_h20_scrb(XBH_U8 port, XBH_U8 scrb)
{
    switch ( scrb )
    {
        case HDMI_MODE_AUTO:
...
void ChipIt66353_2::_sw_config_timer0(XBH_U8 count)
{
    // init timer = count[6:0] * 10 ms
    h2swwr(0x1C, count);
}

void ChipIt66353_2::_sw_enable_timer0(void)
{
    h2swset(0x38, 0x02, 0x02);
}

void ChipIt66353_2::_sw_clear_timer0_interrupt(void)
{
    h2swset(0x28, 0x02, 0x02);
}

void ChipIt66353_2::_sw_enable_txoe_timer_check(void)
{
    _sw_disable_timer0();
...
void ChipIt66353_2::_sw_disable_txoe_timer_check(void)
{
    _sw_disable_timer0();
}


void ChipIt66353_2::_sw_show_hdcp_status(void)
{
    XBH_U8 hdcp_sts;
...
XBH_U8 ChipIt66353_2::it6635_get_port_info1(XBH_U8 port, XBH_U8 info)
{
    XBH_U8 tmp;
...
void ChipIt66353_2::_tx_ovwr_hdmi_mode(XBH_U8 mode)
{
    switch ( mode )
    {
        case HDMI_MODE_AUTO:
...
void ChipIt66353_2::_tx_setup_afe(XBH_U32 vclk)
{
...
XBH_U8 ChipIt66353_2::_rx_calc_edid_sum(XBH_U8 *edid )
{
    XBH_U8 i;
    XBH_U16 sum = 0x100;
...
void ChipIt66353_2::_rx_caof_init(XBH_U8 port)
{
    XBH_U8 reg08;
    XBH_U8 failcnt;
...
void ChipIt66353_2::_rx_show_ced_info(void)
{
...
void ChipIt66353_2::_rx_setup_afe(XBH_U32 vclk)
{
    chgrxbank(3);
...
XBH_U8 ChipIt66353_2::_rx_is_any_ch_symlock(void)
{
    if ( (h2rxrd(0x14) & 0x38) )
    {
        return 1;
...
XBH_U8 ChipIt66353_2::_rx_is_all_ch_symlock(void)
{
...
bool ChipIt66353_2::_rx_is_5v_active(void)
{
...
XBH_U8 ChipIt66353_2::_rx_is_clock_stable(void)
{
...
#if EN_AUTO_RS
XBH_U8 ChipIt66353_2::_rx_need_hpd_toggle(void)
{
    XBH_U8 hdcp_sts;
    if ( gdev.vars.Rev >= 0xC0 )
    {
...
void ChipIt66353_2::_rx_int_enable(void)
{
...
void ChipIt66353_2::_rx_wdog_rst(XBH_U8 port)
{
    #if 0
    XBH_U8 mask;
...
void ChipIt66353_2::_rx_ovwr_hdmi_mode(XBH_U8 port, XBH_U8 mode)
{
    switch ( mode )
    {
        case HDMI_MODE_AUTO:
...
void ChipIt66353_2::_rx_set_hpd(XBH_U8 port, XBH_U8 hpd_value, XBH_U8 term_value)
{
    //xbh patch begin
...
void ChipIt66353_2::_rx_set_hpd_all(XBH_U8 value)
{
    XBH_U8 i;
...
void ChipIt66353_2::_rx_set_hpd_with_5v_all(XBH_U8 non_active_port_only)
{
    XBH_U8 i;
    for ( i = 0; i < RX_PORT_COUNT; i++ )
    {
...
/*XBH_U8 ChipIt66353_2::_rx_get_all_port_5v(void)
{
    XBH_U8 i;
    XBH_U8 ret = 0;
    for ( i = 0; i < RX_PORT_COUNT; i++ )
...
void ChipIt66353_2::_rx_handle_output_err(void)
{
#if EN_AUTO_RS
...
void ChipIt66353_2::_rx_auto_power_down_enable(XBH_U8 port, XBH_U8 enable)
{
    if ( enable )
    {
        //
...
void ChipIt66353_2::_rx_auto_power_down_enable_all(XBH_U8 enable)
{
    XBH_U8 i;
    for ( i = 0; i < RX_PORT_COUNT; i++ )
    {
...
void ChipIt66353_2::_rx_term_power_down(XBH_U8 port, XBH_U8 channel)
{
    // to detect clock,
...
void ChipIt66353_2::_sw_int_enable(XBH_U8 port, XBH_U8 enable)
{
    if ( enable )
    {
...
void ChipIt66353_2::_sw_int_enable_all(XBH_U8 enable)
{
    XBH_U8 i;
    for ( i = 0; i < RX_PORT_COUNT; i++ )
    {
...
void ChipIt66353_2::_sw_disable_timer0(void)
{
...
#if EN_AUTO_RS
XBH_U8 ChipIt66353_2::_sw_get_timer0_interrupt(void)
{
...
void ChipIt66353_2::_sw_config_timer1(XBH_U8 count)
{
    // init timer = count[6:0] * 10 ms
...
void ChipIt66353_2::_sw_enable_timer1(void)
{
    h2swset(0x38, 0x04, 0x04);
}

void ChipIt66353_2::_sw_disable_timer1(void)
{
    h2swset(0x38, 0x04, 0x00);
}

XBH_U8 ChipIt66353_2::_sw_get_timer1_interrupt(void)
{
    return ( (h2swrd(0x28)&0x04) );
}

void ChipIt66353_2::_sw_clear_timer1_interrupt(void)
{
    h2swset(0x28, 0x04, 0x04);
}

void ChipIt66353_2::_sw_enable_hpd_toggle_timer(XBH_U8 timeout)
{
    // init timer = count[6:0] * 10 ms
    // init timer = BIT7|count[6:0] * 100 ms
...
void ChipIt66353_2::_sw_disable_hpd_toggle_timer(void)
{
    _sw_disable_timer1();
}

XBH_U8 ChipIt66353_2::_sw_check_hpd_toggle_timer(void)
{
    return _sw_get_timer1_interrupt();
}

void ChipIt66353_2::_sw_reset_scdc_monitor(void)
{
    h2swwr(0xAD, 0xFF);
}

void ChipIt66353_2::_sw_monitor_and_fix_scdc_write(void)
{
    XBH_U8 reg;
    reg = h2swrd(0xAD);
...
void ChipIt66353_2::_sw_clear_hdcp_status(void)
{
    h2swwr(0xB0, 0xC0);
}

void ChipIt66353_2::_sw_sdi_check(void)
{
    XBH_U8 port;
    XBH_U8 reg6C, reg70;
...
void ChipIt66353_2::_sw_hdcp_access_enable(XBH_U8 enable)
{
...
void ChipIt66353_2::_tx_init(void)
{
...
void ChipIt66353_2::_tx_reset(void)
{
    PR_INFO(("TX Reset\r\n"));
...
void ChipIt66353_2::_rx_init(void)
{
...
void ChipIt66353_2::_rx_reset(void)
{
    PR_INFO(("RX Reset\r\n"));
...
void ChipIt66353_2::_sw_init(void)
{
    XBH_U8 port;
...
void ChipIt66353_2::_sw_reset(void)
{
...
void ChipIt66353_2::it6635_init_rclk(void)
{
#if EN_CEC
    if ( gdev.opts.EnCEC )
    {
...
XBH_U8 ChipIt66353_2::it6635_get_port_info0(XBH_U8 port, XBH_U8 info)
{
    XBH_U8 tmp;
...
void ChipIt66353_2::it6635_enable_tx_port(XBH_U8 enable)
{
    h2swset(0x50, 0x08, (enable << 3));
}

void ChipIt66353_2::it6635_txoe(XBH_U8 enable)
{
...
void ChipIt66353_2::it6635_auto_txoe(XBH_U8 enable)
{
...
void ChipIt66353_2::it6635_set_tx_5v(XBH_U8 output_value)
{
...
XBH_U32 ChipIt66353_2::it6635_get_rx_vclk(XBH_U8 port)
{
    XBH_U32 tmds_clk;
    #if USING_WDOG
...
void ChipIt66353_2::it6635_detect_port(XBH_U8 port)
{
    XBH_U8 sw_reg20;
    XBH_U8 sw_reg21;
    XBH_U8 rddata;
...
void ChipIt66353_2::it6635_detect_ports(void)
{
    XBH_U8 i;
...
void ChipIt66353_2::it6635_rx_irq(void)
{
...
void ChipIt66353_2::it6635_sw_irq(XBH_U8 port)
{
    XBH_U8 sw_reg20;
    XBH_U8 sw_reg21;
    XBH_U8 rddata;
...
void ChipIt66353_2::it6635_tx_irq(void)
{
    XBH_U8 sw_reg27;
    XBH_U8 sw_reg28;
    XBH_U8 rddata;
...
void ChipIt66353_2::it6635_wait_for_ddc_idle(void)
{
    XBH_U8 ddc_sts;
    XBH_U8 idle_cnt = 0;
    XBH_U8 busy_cnt = 0;
...
void ChipIt66353_2::it6635_fsm_chg( XBH_U8 new_state )
{
...
void ChipIt66353_2::it6635_fsm_chg_delayed( XBH_U8 new_state )
{
    XLOGD("[%s:%d] state_fsm %s -> %s ", __func__, __LINE__, s__SYS_FSM_STATE[gdev.vars.state_sys_fsm], s__SYS_FSM_STATE[new_state]);
...
void ChipIt66353_2::_rx_pll_reset(void)
{
...
void ChipIt66353_2::it6635_auto_detect_hdmi_encoding(void)
{
...
void ChipIt66353_2::it6635_force_hdmi20(void)
{
...
void ChipIt66353_2::it6635_force_hdmi14(void)
{
...
void ChipIt66353_2::it6635_fix_incorrect_hdmi_encoding(void)
{
...
#if EN_AUTO_RS
void ChipIt66353_2::it6635_fsm_EQ_check(void)
{
    XBH_U8 eq_state;
...
void ChipIt66353_2::it6635_fsm(void)
{
//LOOP_FSM:
...
void ChipIt66353_2::it6635_irq(void)
{
    XBH_U8 sys_int_sts;
...
bool ChipIt66353_2::it6635_device_init(void)
{
    XBH_U8 i;
    bool init_done = 0;
...
XBH_U8 ChipIt66353_2::it66353_get_init_status(void)
{
    if (mInitStatus == 1)
    {
        return 1;
...
void ChipIt66353_2::it6635_vars_init(void)
{
    // FW Variables init:
    gdev.vars.state_dev_init = 0;
...
bool ChipIt66353_2::it6635_is_device_ready(void)
{
    XBH_U8 vendor_id[2] = { 0 };
...
bool ChipIt66353_2::it6635_read_edid(XBH_U8 block, XBH_U8 offset, int length, XBH_U8 *edid_buffer)
{
 ...
 */
bool ChipIt66353_2::it6635_read_one_block_edid(XBH_U8 block, XBH_U8 *edid_buffer)
{
    XBH_U8 offset;
    XBH_U8 i;
    XBH_U8 read_len = 16;
...
void ChipIt66353_2::it6635_parse_edid_for_vsdb(XBH_U8 *edid)
{
    int off;
    XBH_U8 tag;
    XBH_U8 len;
 ...
 */
void ChipIt66353_2::it6635_parse_edid_for_phyaddr(XBH_U8 *edid)
{
    int off;
    XBH_U8 tag;
    XBH_U8 len;
...
void ChipIt66353_2::it6635_setup_edid_ram_step2(XBH_U8 block)
{
    int i;
    XBH_U8 wcount = 16;
    XBH_U8 phyAB, phyCD;
...
void ChipIt66353_2::it6635_ddc_abort(void)
{
...
XBH_BOOL ChipIt66353_2::it6635_update_edid(XBH_U8 block, XBH_U8 *edid_buf, XBH_U8 flag)
{
    XBH_U8 i;
    XBH_BOOL ret;
    XBH_U8 retry=0;
...
bool ChipIt66353_2::it6635_setup_edid_ram(XBH_U8 flag)
{
    XBH_U8 edid_tmp[128];
    XBH_U8 extblock;
    XBH_U8 i;
...
void ChipIt66353_2::it66353_dev_reset(void){
    PR_ERR(("it66353_dev_reset "));
    mResetPort = gdev.vars.Rx_new_port;
    dev_state = DEV_WAIT_RESET;
}

void ChipIt66353_2::it6635_dev_loop(void)
{
...
void ChipIt66353_2::it6635_dump_opts(void)
{
...
#define BUF_LEN 16
void ChipIt66353_2::it6635_dump_register( XBH_U8 addr, char *reg_desc)
{
...
void ChipIt66353_2::it6635_dump_register_all(void)
{
...
XBH_BOOL ChipIt66353_2::it6635_write_edid(XBH_U8 block, XBH_U8 offset, int length, XBH_U8 *data_buffer)
{
...
bool ChipIt66353_2::it6635_write_one_block_edid(XBH_U8 block, XBH_U8 *edid_buffer)
{
    XBH_U8 offset;
    XBH_U8 i;
    XBH_U8 op_len = 16;
...
XBH_U8 ChipIt66353_2::it6635_is_5v_present(XBH_U8 port)
{
    if ( port < RX_PORT_COUNT )
    {
...
XBH_U8 ChipIt66353_2::it6635_is_clock_detected(XBH_U8 port)
{
    if ( port < RX_PORT_COUNT )
    {
...
void ChipIt66353_2::it6635_set_option(IT6635_DEVICE_OPTION *Opts)
{
    if ( Opts )
    {
...
void ChipIt66353_2::it6635_get_option(IT6635_DEVICE_OPTION *Opts)
{
    if ( Opts )
    {
...
void ChipIt66353_2::it6635_dev_restart(void)
{
...
XBH_U8 ChipIt66353_2::it6635_get_RS(void)
{
    //return gdev.EQ.FixedRsIndex[gdev.vars.Rx_active_port];
    return 0;
}

void ChipIt66353_2::it6635_set_RS(XBH_U8 rs_idx0, XBH_U8 rs_idx1, XBH_U8 rs_idx2)
{
    XBH_U8 rs[3];
...
void ChipIt66353_2::it6635_set_ch_RS(XBH_U8 ch, XBH_U8 rs_index)
{
    XBH_U8 rs;
    if ( rs_index < 14 )
    {
...
void ChipIt66353_2::it6635_set_rx_hpd(XBH_U8 hpd_value)
{
 ...
 */
void ChipIt66353_2::it6635_set_internal_EDID( XBH_U8 block, XBH_U8 *edid, XBH_U8 target_port )
{
    int i;
    XBH_U8 wcount = 16;
 ...
 *
 */
void ChipIt66353_2::it6635_get_internal_EDID( XBH_U8 block, XBH_U8 *edid, XBH_U8 target_port )
{
    int i;
    XBH_U8 wcount = 16;
 ...
 *
 */
void ChipIt66353_2::it6635_change_default_RS( XBH_U8 port, XBH_U8 new_rs_idx0, XBH_U8 new_rs_idx1, XBH_U8 new_rs_idx2, XBH_U8 update_hw )
{
    if ( port <= RX_PORT_3 )
    {
 ...
 *
 */
void ChipIt66353_2::it6635_force_rx_hpd( XBH_U8 hpd_state )
{
 ...
 *
 */
bool ChipIt66353_2::it6635_toggle_hpd(XBH_U16 ms_duration)
{
    XBH_U8 timeout;
    bool ret=XBH_TRUE;
...
XBH_U8 ChipIt66353_2::it6635_i2c_write(XBH_U32 u32I2cNum, XBH_U8 addr, XBH_U8 offset, XBH_U8 length, XBH_U8 *buffer)
{
...
XBH_U8 ChipIt66353_2::it6635_i2c_read(XBH_U32 u32I2cNum, XBH_U8 addr, XBH_U8 offset, XBH_U8 length, XBH_U8 *buffer)
{
    if (buffer == NULL){
        return FALSE;
    }
...
void ChipIt66353_2::delay1ms(unsigned short ms)
{
    usleep(ms * 1000);
}

unsigned long ChipIt66353_2::get_tick_count(void)
{
    return 0;
}

ChipIt66353_2::ChipIt66353_2(XBH_U32 DevNo, XBH_U32 SwAddr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel, XBH_U8 defaultPort, HDMI_SWITCH_PORT u8SwitchPort, XBH_U8 level)
{
    // Rx操作参数
    s_RxOpts = {
        0xC3, //XBH_U8 tag1;
...
ChipIt66353_2::~ChipIt66353_2()
{

}

void ChipIt66353_2::start()
{
    XbhMWThread::run(REPEAT);
}

void ChipIt66353_2::run(const void* arg)
{
    if(initState){
 ...
 * hw: 采用硬复位还是软复位
 */
XBH_S32 ChipIt66353_2::resetChip(XBH_BOOL hw)
{
 ...
 * value 高低状态
 */
XBH_S32 ChipIt66353_2::setRxHpd(XBH_U8 port, XBH_BOOL high)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
 ...
 * port: 指定的port
 */
XBH_S32 ChipIt66353_2::setActivePort(XBH_U8 port)
{
    XbhMutex::Autolock _l(mLock);
    if ( port < RX_PORT_COUNT )
    {
 ...
 * port: 指定的port
 */
XBH_S32 ChipIt66353_2::getActivePort(XBH_U8* port)
{
    XBH_S32 s32Ret = XBH_SUCCESS;
    *port = gdev.vars.Rx_active_port;
    return s32Ret;
 ...
 * status：信号状态
 */
XBH_S32 ChipIt66353_2::getRxPortStatus(XBH_U8 port, XBH_U8* status)
{
