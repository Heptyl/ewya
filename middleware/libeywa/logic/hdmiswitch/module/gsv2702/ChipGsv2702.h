#ifndef CHIP_GSV2702_H
#define CHIP_GSV2702_H
...
#define XBH_GSV2702_DEVICE_ADDRESS                  (0x58)

#define XBH_GSV2702_DEVICE_CHIP_NAME_ADD            (0xff3c)
#define XBH_GSV2702_DEVICE_CHIP_NAME_LEN            (2)

#define XBH_GSV2702_DEVICE_FIRMWARE_VERSION_ADD     (0xff3e)
#define XBH_GSV2702_DEVICE_FIRMWARE_VERSION_LEN     (2)

#define XBH_GSV2702_MAILBOX_MAP_ADDR                (0xff)

#define XBH_GSV2702_APP_OFFSET_AT_FLASH             (0x0)
#define XBH_GSV2702_APP_VERSION_MAJOR               (1)
#define XBH_GSV2702_APP_VERSION_MINOR               (0)

#define XBH_GSV2702_DEVICE_ADDRESS                  (0x58)
#define XBH_GSV2702_TRANSFER_START                  (0x55)
#define XBH_GSV2702_TRANSFER_END                    (0xAA)

#define XBH_GSV2702_ROLL_BACK_INCDATA               (0x10)
#define XBH_GSV2702_RXDDC_INFO_CMD                  (0x09)
#define XBH_GSV2702_RXDDC_DATA_CMD                  (0x06)
#define XBH_GSV2702_RXDDC_INFO_ACK                  (0x09)
#define XBH_GSV2702_RXDDC_DATA_ACK                  (0x0A)

//I2C
#define XBH_GSV2702_RXDDC_UPDCONFIGID               (0xFF22)
#define XBH_GSV2702_RXDDC_UPDREPLYID                (0xFF27)
#define XBH_GSV2702_RXDDC_REPLY                     (0xFF2B)
#define XBH_GSV2702_RXDDC_COMMAND                   (0xFF2C)
#define XBH_GSV2702_RXDDC_REBOOT                    (0xFF2D)
#define XBH_GSV2702_RXDDC_UPDINFO                   (0xFF30)
#define XBH_GSV2702_RXDDC_INFOCHECKSUM              (0xFF2F)
#define XBH_GSV2702_RXDDC_UPDDATA                   (0xFF40)
#define XBH_GSV2702_RXDDC_DATACHECKSUM              (0xFF80)

#define XBH_GSV2702_PARTITION_A_ADDR                (0x0001000)
#define XBH_GSV2702_PARTITION_B_ADDR                (0x0040000)

#define XBH_GSV2702_PARTTION_A                      (0)
#define XBH_GSV2702_PARTTION_B                      (1)

#define XBH_TRANSFER_DATA_BLKSIZE                   (64)

#define GSV2702_VERSION                "persist.vendor.xbh.ver.gsv2702"


enum GSV2702Upgrade_STATE_E {
       GSV2702Upgrade_IDLE          = 0,
       GSV2702Upgrade_RUNNING       = 1,
       GSV2702Upgrade_SUCCESS       = 2,
       GSV2702Upgrade_FAILURE       = 3,
};
...
static const unsigned char crc8Gsv2702Table[256] =
{
...
static XBH_U8 dataGsv2702Buff[128] =  {0};
...
class ChipGsv2702 : public XbhMWThread, public XbhHdmiSwitchInterface
{
public:
    /**
     ...
     */
    ChipGsv2702(XBH_S32 i2cNumber, XBH_S32 i2cAddress, XBH_S32 powerGpio, XBH_S32 powerLevel ,XBH_S32 resetGpio, XBH_S32 resetLevel , XBH_S32 defaultPort , HDMI_SWITCH_PORT u8SwitchPort, XBH_U8 level);
