#ifndef CHIP_GSV2715_H
#define CHIP_GSV2715_H
...
#define REG_SELECT_CHARGE 0xFF81
...
#define REG_TYPEC_RESET 0xFF0D

#define XBH_GSV2715_DEVICE_ADDRESS                  (0x58)

#define XBH_GSV2715_DEVICE_CHIP_NAME_ADD            (0xff3c)
#define XBH_GSV2715_DEVICE_CHIP_NAME_LEN            (2)

#define XBH_GSV2715_DEVICE_FIRMWARE_VERSION_ADD     (0xff3e)
#define XBH_GSV2715_DEVICE_FIRMWARE_VERSION_LEN     (2)

#define XBH_GSV2715_MAILBOX_MAP_ADDR                (0xff)

#define XBH_GSV2715_APP_OFFSET_AT_FLASH             (0x0)
#define XBH_GSV2715_APP_VERSION_MAJOR               (1)
#define XBH_GSV2715_APP_VERSION_MINOR               (0)

#define XBH_GSV2715_DEVICE_ADDRESS                  (0x58)
#define XBH_GSV2715_TRANSFER_START                  (0x55)
#define XBH_GSV2715_TRANSFER_END                    (0xAA)

#define XBH_GSV2715_ROLL_BACK_INCDATA               (0x10)
#define XBH_GSV2715_RXDDC_INFO_CMD                  (0x09)
#define XBH_GSV2715_RXDDC_DATA_CMD                  (0x06)
#define XBH_GSV2715_RXDDC_INFO_ACK                  (0x09)
#define XBH_GSV2715_RXDDC_DATA_ACK                  (0x0A)
...
//I2C
#define XBH_GSV2715_RXDDC_UPDCONFIGID               (0xFF22)
#define XBH_GSV2715_RXDDC_UPDREPLYID                (0xFF27)
#define XBH_GSV2715_RXDDC_REPLY                     (0xFF2B)
#define XBH_GSV2715_RXDDC_COMMAND                   (0xFF2C)
#define XBH_GSV2715_RXDDC_REBOOT                    (0xFF2D)
#define XBH_GSV2715_RXDDC_UPDINFO                   (0xFF30)
#define XBH_GSV2715_RXDDC_INFOCHECKSUM              (0xFF2F)
#define XBH_GSV2715_RXDDC_UPDDATA                   (0xFF40)
#define XBH_GSV2715_RXDDC_DATACHECKSUM              (0xFF80)
#define XBH_GSV_RXID_ADDR                           (0xFF26)
#define XBH_GSV_BKSV_ADDR                           (0xFF2B)
#define XBH_GSV_BKSV_IS_EXSIT_ADDR                  (0xFF21)
#define XBH_GSV_RXID_IS_EXSIT_ADDR                  (0xFF20)
#define XBH_GSV2715_PARTITION_A_ADDR                (0x0001000)
#define XBH_GSV2715_PARTITION_B_ADDR                (0x0040000)

#define XBH_GSV2715_PARTTION_A                      (0)
#define XBH_GSV2715_PARTTION_B                      (1)

#define XBH_TRANSFER_DATA_BLKSIZE                   (64)

#define GSV2715_VERSION                "persist.vendor.xbh.ver.gsv2715"

enum GSV2715Upgrade_STATE_E {
       GSV2715Upgrade_IDLE          = 0,
       GSV2715Upgrade_RUNNING       = 1,
       GSV2715Upgrade_SUCCESS       = 2,
       GSV2715Upgrade_FAILURE       = 3,
};
...
static const unsigned char crc8Gsv2715Table[256] =
{
...
static XBH_U8 dataGsv2715Buff[128] =  {0};
...
class ChipGsv2715 : public XbhMWThread, public XbhHdmiSwitchInterface
{
public:
    /**
     ...
     */
    ChipGsv2715(XBH_S32 i2cNumber, XBH_S32 i2cAddress, XBH_S32 powerGpio, XBH_S32 powerLevel ,XBH_S32 resetGpio, XBH_S32 resetLevel , XBH_S32 defaultPort , HDMI_SWITCH_PORT u8SwitchPort, XBH_U8 level);
    ...
    /**
        根据OPS插入状态，动态设置PD功率
    */
    XBH_S32 setChargingPower(XBH_U8 data);
