#ifndef XBH_CHIP_ITE6563_H
#define XBH_CHIP_ITE6563_H
...
#define ITE6563_DEFAULT_FIREWARE    "/mnt/cust/firmware/ite6563/ite6563.bin"

class ChipIte6563 : public XbhMWThread, public XbhDp2HdmiInterface
{
...
public:
     ...
     * rLevel       复位工作时的电平状态
    */
    ChipIte6563(XBH_U32 i2cBus, XBH_U32 Addr, XBH_S32 pGpio, XBH_S32 pLevel, XBH_S32 rGpio, XBH_S32 rLevel);
    ~ChipIte6563();
    /**
     * 复位当前转换芯片
     */
