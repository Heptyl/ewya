...
const static XBH_U16 crc16Table8005[] = {
...
XBH_U16 XbhCrc::calCrc16By8005(unsigned char *pBuff, unsigned int length)
{
    XBH_U16 u16CRC = 0x0000;
    XBH_U16 u16Tmp;
    while (length--)
    {
        u16Tmp = ((*pBuff++) << 8);
        u16CRC = (u16CRC << 8) ^ crc16Table8005[((u16CRC ^ u16Tmp) >> 8) & 0xff];
    }
    return u16CRC;
}
